...
//
		...
		if (p < config.getFloat("simulation.eventDiffusion.subscriptionRatio"))
		{
...
//		}
		...
		if (agent.getAID().getLocalName().equals("Container-1_a_1"))
		{
			pubCount++;
			EventPublishingTest t = new EventPublishingTest(agent, 30000, a,
